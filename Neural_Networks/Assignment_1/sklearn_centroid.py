...
train_generator = train_datagen.flow_from_directory(
    ...
    batch_size=batch_size, # Irrelevant for our usage with the centroid classifier
    class_mode='sparse',
    shuffle=False
)
...
# Train the Nearest Centroid classifier on the training data
...
def evaluate_classifier():
    ...
    for test_images, labels in test_generator:
        ...
        predictions = nc.predict(test_images)
